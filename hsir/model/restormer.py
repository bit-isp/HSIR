...
def restormer_b31_d32():
    net = Restormer(31, 31, dim=32)
    return net


def restormer_b31_d24():
    net = Restormer(31, 31, dim=24)
    return net
...
def restormer_b31_tlc():
    net = RestormerLocal(31, 31, train_size=(1, 31, 64, 64), base_size=(64, 64))
    return net
